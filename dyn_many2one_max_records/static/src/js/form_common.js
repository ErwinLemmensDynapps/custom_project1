odoo.define('xx_stock.form_common', function (require) {
    "use strict";
            ...
            return this.orderer.add(dataset.name_search(
                ...
                if (values.length > self.limit) {
                    ...
                    values.push({
                        ...
                        action: function () {
                            var max_records = 160;
                            if (self.options && self.options.xx_max_records)
                                max_records = self.options.xx_max_records;

                            dataset.name_search(search_val, self.build_domain(), 'ilike', max_records).done(function (_data) {
